...
I've developed a videogame in 2016, and another one in 2017. I've also published and android app in 2021 and an augmented reality Javascript library which, with the use of Aframe.js and Handsfree.js, users can visualize, grab and handle objects floating around them them with their bare hands without markers. One of the topics that I enjoy most is low-level programming in C and assembly, and I would like to learn more about Rust and BlockChain.
